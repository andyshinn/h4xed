...
class Playlist extends Controller {
	...
	function Playlist() {
		...
		$this->load->helper(array('url', 'form', 'string', 'date', 'debug'));
	}
	...
	function recent() {
		...
		$query_recent = $this->playlist->recently_added(5);
		$recently_added = $query_recent->result();
		
		print_array($query_recent);
	}
	...
	function artists($letter = 'all', $limit_offset = 0) {
		...
		$config['cur_tag_open'] = ' <span id="pagination" class="current">';
