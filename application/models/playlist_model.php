...
class Playlist_model extends Model
{
	...
	function recently_added($limit = 10)
	{
		return $this->search_album(null, $limit, true);
	}
	...
	function search_album($pattern = NULL, $limit = 10, $is_album = true, $order_by = 'date_added', $order = 'desc')
	{
