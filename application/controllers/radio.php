...
class Radio extends CI_Controller {
		...
		if ($stream_id && $list_type) {
			switch($list_type) {
				case 'asx' :
					...
					$file_data = "<ASX version = \"3.0\">
					<TITLE>H4XED Metal</TITLE>
					<MoreInfo href = \"${base_url}\" />
					<Entry>
      					<Ref href = \"http://sc-01.h4xed.us:$stream_id\" />
      					<PARAM NAME=\"HTMLView\" Value=\"${base_url}radio/news\"/>
					</Entry>
					</ASX>";
					break;
				case 'm3u' :
				...
				default :
					...
					$file_data = "<ASX version = \"3.0\">
					<TITLE>H4XED Metal</TITLE>
					<MoreInfo href = \"http://radio.h4xed.us\" />
					<Entry>
      					<Ref href = \"http://sc-01.h4xed.us:$stream_id\" />
      					<PARAM NAME=\"HTMLView\" Value=\"$base_url/radio/news\"/>
					</Entry>
			...
			$this -> _output_playlist($file_name, $file_data, $mime_type);
	...
	function _output_playlist($file_name, $file_data, $mime_type = 'application/force-download') {
		@ob_end_clean();
